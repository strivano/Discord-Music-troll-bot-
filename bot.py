...
async def play(ctx, music: str = None):
	if music == None:
		...
		print(f"{get_time()} [+] Connected to the channel")
		print(f"{get_time()} [+] Playing the sound...")
		vc.play(discord.FFmpegPCMAudio('monkey.mp3'))
		while vc.is_playing():
			time.sleep(1)
		await vc.disconnect()
		print(f"{get_time()} [+] Left the channel")
		...
		print(f"{get_time()} [+] Connected to the channel")
		print(f"{get_time()} [+] Playing the sound...")
		vc.play(discord.FFmpegPCMAudio('pokemon.mp3'))
		while vc.is_playing():
			time.sleep(1)
		await vc.disconnect()
		print(f"{get_time()} [+] Left the channel")
		...
		print(f"{get_time()} [+] Connected to the channel")
		print(f"{get_time()} [+] Playing the sound...")
		vc.play(discord.FFmpegPCMAudio('daddy.mp3'))
		while vc.is_playing():
			time.sleep(1)
		await vc.disconnect()
		print(f"{get_time()} [+] Left the channel")
		...
		print(f"{get_time()} [+] Connected to the channel")
		print(f"{get_time()} [+] Playing the sound...")
		vc.play(discord.FFmpegPCMAudio('najlonkesa.mp3'))
		while vc.is_playing():
			time.sleep(1)
		await vc.disconnect()
		print(f"{get_time()} [+] Left the channel")
		...
		print(f"{get_time()} [+] Connected to the channel")
		print(f"{get_time()} [+] Playing the sound...")
		vc.play(discord.FFmpegPCMAudio('golagola.mp3'))
		while vc.is_playing():
			time.sleep(1)
		await vc.disconnect()
		print(f"{get_time()} [+] Left the channel")
		...
		print(f"{get_time()} [+] Connected to the channel")
		print(f"{get_time()} [+] Playing the sound...")
		vc.play(discord.FFmpegPCMAudio('pustinogu.mp3'))
		while vc.is_playing():
			time.sleep(1)
		await vc.disconnect()
		print(f"{get_time()} [+] Left the channel")
		...
		print(f"{get_time()} [+] Connected to the channel")
		print(f"{get_time()} [+] Playing the sound...")
		vc.play(discord.FFmpegPCMAudio('malamala.mp3'))
		while vc.is_playing():
			time.sleep(1)
		await vc.disconnect()
		print(f"{get_time()} [+] Left the channel")
		...
		print(f"{get_time()} [+] Connected to the channel")
		print(f"{get_time()} [+] Playing the sound...")
		vc.play(discord.FFmpegPCMAudio('phintro.mp3'))
		while vc.is_playing():
			time.sleep(1)
		await vc.disconnect()
		print(f"{get_time()} [+] Left the channel")
